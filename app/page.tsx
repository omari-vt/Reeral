    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <nav className="bg-white border-b border-gray-200 px-6 py-4 flex justify-between items-center">
        ...
        <div className="flex gap-3">
          <button className="px-4 py-2 text-sm border border-gray-200 rounded-lg">
            Connexion
          </button>
      ...
      <div className="bg-green-600 text-white text-center py-12 px-6">
        ...
        <div className="flex gap-3 justify-center">
          <button
            ...
            className="px-6 py-3 bg-white text-green-600 font-medium rounded-xl"
          >
            Objet perdu
          </button>
          <button
            ...
            className="px-6 py-3 border border-white text-white font-medium rounded-xl"
          >
            Objet trouve
          </button>
        </div>
        ...
        <div className="max-w-lg mx-auto mt-6 px-6">
          <div className="bg-white border border-gray-200 rounded-xl p-6">
            ...
            <div className="flex flex-col gap-3">
              <input
                type="text"
                placeholder="Titre de l objet (ex: Telephone Samsung)"
                value={titre}
              ...
              <input
                type="text"
                placeholder="Lieu (ex: Marche Sandaga, Dakar)"
                value={lieu}
                onChange={(e) => setLieu(e.target.value)}
                className="border border-gray-200 rounded-lg px-4 py-2 text-sm outline-none focus:border-green-400 text-gray-900 bg-white"
              />
              <textarea
                placeholder="Description (couleur, marque, details...)"
                value={description}
